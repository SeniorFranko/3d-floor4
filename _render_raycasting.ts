...
namespace Render {
    ...
    export class RayCastingRender {
        ...
        get viewAngle(): number { return this._angle }
        ...
        get wallZScale(): number {  return this._wallZScale  }
        set wallZScale(v: number) { this._wallZScale = v   }
        ...
        getZOffset(spr: Sprite) {return this.getMotionZ(spr).offset / fpx_scale  }
        ...
        getMotionZPosition(spr: Sprite) {  return this.getMotionZ(spr).p / fpx_scale   }
        ...
        render() {
            ...
            for (let x = 0; x < SW; x++) {
               ...
               const tex = this.textures[color]
                ...
                let drawHeight = Math.ceil(drawEnd) - Math.ceil(drawStart)
                drawStart = 70 + Math.ceil(drawStart)
                drawEnd += 70
           ...
           // this.tempScreen.print(debugA.toString(), 0, 10, 7)
